...
- **Generated:** `2026-06-15T19:16:14.982365+00:00`
- **Source root:** `.`
- **Flows:** 33
- **Entry points:** 29
- **Potential gaps:** 14
...
- **WARNING · missing_branch** Decision has no explicit fallback: if/elif on account.status ([`examples/shop/backend/api/users_routes.py:15`](../examples/shop/backend/api/users_routes.py#L15))
...
**Review points:**
- `account.status == AccountStatus.SUSPENDED`: Decision has no explicit fallback: if/elif on account.status
