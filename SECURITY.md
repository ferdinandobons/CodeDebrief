...
cache under `.codedebrief/`. It does not upload source code or require an API key.

The MCP server exposes only CodeDebrief model operations and an explicit project refresh.
